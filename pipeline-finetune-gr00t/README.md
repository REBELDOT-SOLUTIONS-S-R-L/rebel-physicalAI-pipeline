...
Configure via Databricks CLI before running the pipeline:

```bash
# Brev
databricks secrets put-secret brev token --string-value "..."
databricks secrets put-secret brev instance --string-value "..."
databricks secrets put-secret brev brev_ip --string-value "..."
databricks secrets put-secret brev ssh_public_key --string-value "..."
databricks secrets put-secret brev ssh_private_key --string-value "..."
databricks secrets put-secret brev dataset_name --string-value "..."
databricks secrets put-secret brev max_steps --string-value "..."
databricks secrets put-secret brev save_steps --string-value "..."
databricks secrets put-secret brev task_name --string-value "..."

# WandB
databricks secrets put-secret wandb token --string-value "..."

# Databricks
databricks secrets put-secret databricks pat --string-value "..."